...
namespace festpay\tests;

use festpay\PaymentPage;
use festpay\SignatureHandler;
use festpay\Payment;
...
class PaymentPageTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetUrl()
    {
        ...
        self::assertEquals(
            'https://paymentpage.festpay.ru/payment?project_id=100&interface_type=%7B%22id%22%3A23%7D'
